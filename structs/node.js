function Node(value, height, par, l_child, r_child) {
  ...
  this.return_inside_canvas = function(inside_box) {
    if (this.l_child!=null) this.l_child.return_inside_canvas(inside_box);
    if (!this.isLeaf() && is_inside_canvas(this.x(sweepline))) {
      inside_box.push(this);
    }
    if (this.r_child!=null) this.r_child.return_inside_canvas(inside_box);
  };
